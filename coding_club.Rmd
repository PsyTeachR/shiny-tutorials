...
* make your ggplot prettier (e.g., set color and fill for the plot)
...
2021-05-26 14:00 (Europe/London) [Zoom link](https://uofglasgow.zoom.us/j/93838448011)

In this second session, we will learn how to check the user input for errors, such as impossible values, and handle these without crashing.
