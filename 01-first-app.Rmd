...
<p class="alert alert-tryit">What *are* we even plotting here? Type `?faithful` into the console pane to see what the `waiting` column represents. Change the label on the x-axis to something more sensible.</p>
